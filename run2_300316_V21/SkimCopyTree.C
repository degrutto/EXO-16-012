...
void SkimCopyTree(TString fname="ZnnH125", TString outputname = "")
{
 ...
 if (fname.Contains("Data")) {
    ...
    */
    ...
    TCut selection = "met_pt>150 && Jet_btagCSV[hJCidx[1]]>0.3 && HCSV_pt>130 &&  min(Jet_pt[hJCidx[0]],Jet_pt[hJCidx[1]])>30";
