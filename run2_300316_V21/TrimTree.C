...
const TString indir       = "/afs/cern.ch/work/d/degrutto/public/MiniAOD/ZnnHbb_Spring15_PU20bx25/skimV12_v2/step3/";
const TString outdir      = "/afs/cern.ch/work/d/degrutto/public/MiniAOD/ZnnHbb_Spring15_PU20bx25/skimV12_v2/step3/skim_ZnnH_classification/step4/";
...
void TrimTree(TString process="ZnnH125", TString mvaMethod="BDT", Long64_t beginEntry=0, Long64_t endEntry=-1)
{
    ...
    */
    ...
    TString outputname = "";
    if (!reloadStep4) {
      //        inTree = (TTree *) input->Get("tree_ZnunuHighPt");
    ...
    */
    ...
    std::cout << "--- TrimTree                 : There are " << systExpressions.size()-1 << " systematic sources." << std::endl; // <-- FIXME add systematcs
    ...
    /// Split
    if (!reloadStep4) {
        TCut trainCut = "isSignal && (evt %2 == 0)";
        TCut testCut  = "isSignal && (evt %2 == 1)";
