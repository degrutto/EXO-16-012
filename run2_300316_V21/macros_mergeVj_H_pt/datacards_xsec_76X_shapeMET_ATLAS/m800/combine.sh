...
rm zp800_metshapes.txt
combineCards.py SR=zp600metshape1509999_1J_new.txt  SR_1b=zp600metshape1509999_1b_new.txt   TTCR=zp600metshape1509999_TT_new.txt   WbCR=zp600metshape1509999_Wbb_new.txt SB=zp600metshape1509999_SB_new.txt>> zp800_metshapes.txt
more rateParam.txt >> zp800_metshapes.txt
combine -M MaxLikelihoodFit zp800_metshapes.txt --saveShapes --saveWithUncertainties -v 3 --forceRecreateNLL --expectSignal=0  
combine -M Asymptotic -t -1 zp800_metshapes.txt
