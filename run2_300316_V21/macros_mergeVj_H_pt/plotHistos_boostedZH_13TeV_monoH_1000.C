#include "plotHistos_boostedZH_13TeV_monoH_1000.h"
#include "TROOT.h"
#include "TStyle.h"
...
void plotHistos_boostedZH_13TeV_monoH_1000() {
    ...
    TString plotdir = "plotsmonoH_1000/";
...
CR_QCD = <!Cuts|Nothing!> && minDeltaPhiJet2Met<0.7
    ...
    */
    ...
    TString dcname    = "zp1000_mt_0J.txt";   // the datacard name
    ...
    dcname    = "zp1000_mt_1J.txt";   // the datacard name
    ...
    dcname    = "zp1000_mt_SB.txt";   // the datacard name
    ...
    dcname    = "zp1000_mt_1b.txt";   // the datacard name
    ...
    dcname    = "zp1000_mt_0J_3fb.txt";   // the datacard name
    ...
    dcname    = "zp1000_mt_1J_3fb.txt";   // the datacard name
    ...
    dcname    = "zp1000_mt_SB_3fb.txt";   // the datacard name
    ...
    dcname    = "zp1000_mt_1b_3fb.txt";   // the datacard name
