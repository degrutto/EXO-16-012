...
void MakePlots(const Events * ev, TString var,
  ...
  std::clog << "... DONE: project ZH." << std::endl;
    ...
    */
	...
	if (plotBoostedZH)  leg1->AddEntry(hboostedZH, "Z->ZH(MZ'=800), xsec * BR = 1pb", "l");
    ...
    if (plotBoostedZH)  leg1->AddEntry(hboostedZH, "MZ'=800", "l");
    leg1->AddEntry(hTT, "t#bar{t}", "f");
    leg1->AddEntry(hST, "single top", "f");
...
TString indir = "/afs/cern.ch/work/d/degrutto/public/MiniAOD/V21_FromSean/step3/"; //Step4_ZnnH125.root
    ...
    if (loadboostedZH) {
        ...
        //ZH = (TTree *) ZH_.CopyTree(cutmc_all);
        //lumi_ZH = lumis[Form("ZllH%i", massH)];
        boostedZH_.Add(indir + prefix + "monoH_800" + suffix);
	//       boostedZH_.Add("/afs/cern.ch/user/d/degrutto/eos/cms/store/group/cmst3/user/degrutto/VHBBHeppyV21_add/ZprimeToA0hToA0chichihbb_2HDM_MZp-1000_MA0-300_13TeV-madgraph/VHBB_HEPPY_F21_add_ZprimeToA0hToA0chichihbb_2HDM_MZp-1000_MA0-300_13TeV-madgraph__fall15MAv2-pu25ns15v1_76r2as_v12-v1/160407_124903/0000/tree_4.root");
