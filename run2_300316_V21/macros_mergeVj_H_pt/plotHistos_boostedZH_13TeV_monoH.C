...
void plotHistos_boostedZH_13TeV_monoH() {
    ...
    Events * ev = new Events();
     ...
     TCut cutMinimal = "mhtJet30>120 && Jet_btagCSV[hJCidx[1]]>0.4 && HCSV_mass<500 && abs(deltaPhi(HCSV_phi,met_phi))>0.7 && json && (Vtype==2 || Vtype==3 || Vtype==4) &&  HaddJetsdR08_pt>150 && met_pt>150  && min(Jet_pt[hJidx[0]],Jet_pt[hJidx[1]])>30 && Jet_btagCSV[hJidx[1]]>0.4 && Jet_btagCSV[hJidx[0]]>0.4 &&  Jet_id[hJidx[0]]>3 && Jet_id[hJidx[1]]>3";

     TCut cutQCD = "HaddJetsdR08_pt>150 && met_pt>150 &&   MinIf$( abs(deltaPhi(met_phi,Jet_phi)), Jet_pt>30 && Jet_puId &&  abs(Jet_eta)<4.5 )> 0.7 && Jet_btagCSV[hJidx[0]]>0.3 && Jet_btagCSV[hJidx[1]]>0.3 &&  min(Jet_pt[hJidx[0]],Jet_pt[hJidx[1]])>30";


     TCut cutAntiQCD = "HaddJetsdR08_pt>150 && met_pt>150   && Jet_btagCSV[hJidx[0]]>0.3 &&  Jet_btagCSV[hJidx[1]]>0.3 && min(Jet_pt[hJidx[0]],Jet_pt[hJidx[1]])>30";
     ...
     TCut addBCenJet30e0 = "(Sum$(Jet_pt>30 && Jet_puId>3 && abs(Jet_eta)<2.5 && Jet_btagCSV>0.80)-2)==0";
     ...
     TCut cutSignalLoose = "Vtype==4 &&  min(Jet_pt[hJidx[0]],Jet_pt[hJidx[1]])>30 &&  Jet_btagCSV[hJidx[0]]>0.80 &&  Jet_btagCSV[hJidx[1]]>0.80 && (HaddJetsdR08_mass<100 || HaddJetsdR08_mass>140)";

     TCut cutSignal0J = "Vtype==4 &&  min(Jet_pt[hJidx[0]],Jet_pt[hJidx[1]])>30 &&  min(Jet_btagCSV[hJidx[0]], Jet_btagCSV[hJidx[1]])>0.80 && (HaddJetsdR08_mass>100 && HaddJetsdR08_mass<140)" + addCenJet30e0 + naddGoodLeptons10e0 + naddGoodTaus20e0 + addBCenJet30e0;
     TCut cutSignal1J = "Vtype==4 &&  min(Jet_pt[hJidx[0]],Jet_pt[hJidx[1]])>30 &&  max(Jet_btagCSV[hJidx[0]],Jet_btagCSV[hJidx[1]] )>0.80 && min(Jet_btagCSV[hJidx[0]],Jet_btagCSV[hJidx[1]] )>0.46  && (HaddJetsdR08_mass>100 && HaddJetsdR08_mass<140)" + addCenJet30le1 + naddGoodLeptons10e0 + naddGoodTaus20e0 + addBCenJet30e0;
     TCut cutSignalSB = "Vtype==4 &&  min(Jet_pt[hJidx[0]],Jet_pt[hJidx[1]])>30 &&  min(Jet_btagCSV[hJidx[0]],Jet_btagCSV[hJidx[1]])>0.80 && (HaddJetsdR08_mass<100 || HaddJetsdR08_mass>140)" + addCenJet30le1 + naddGoodLeptons10e0 + naddGoodTaus20e0 + addBCenJet30e0; // le1 -> e0

     TCut cutSignal1b = "Vtype==4 &&  min(Jet_pt[hJidx[0]],Jet_pt[hJidx[1]])>30 &&  max(Jet_btagCSV[hJidx[0]],Jet_btagCSV[hJidx[1]])>0.97 && ((HaddJetsdR08_mass>100 && HaddJetsdR08_mass<140))" + addCenJet30e0 ;
     ...
     TCut cutZbb = "Vtype==4 && (HaddJetsdR08_mass<100 || HaddJetsdR08_mass>140)" + addCenJet30e0 +    "min(Jet_btagCSV[hJidx[1]],Jet_btagCSV[hJidx[0]])>0.80";

     //     TCut cutWlight = "(Vtype==2 || Vtype==3) && vLeptons_pt>30" + addCenJet30e0 + /*naddGoodLeptons5m0 +*/ "Jet_btagCSV[hJidx[0]]<0.80";
     TCut cutWlight =   addCenJet30e0 + "(Vtype==2 || Vtype==3) && vLeptons_pt>30" ; /*naddGoodLeptons5m0 +*/;

     TCut cutWbb =  addCenJet30e0 + "(Vtype==2 || Vtype==3) && vLeptons_pt>30" + /*naddGoodLeptons5m0 +*/ "min(Jet_btagCSV[hJidx[1]],Jet_btagCSV[hJidx[0]])>0.80"; 
...
//&& (nhttCandidates==0 || ( nhttCandidates==1 && (httCandidates_mass[0]<120 || httCandidates_mass[0]>190 )))";
     ...
     Higgs candidate:             Vtype >=0
       ...
       H mass <300                 H_reg_mass<300 && HaddJetsdR08_mass>0
     */
...
CR_QCD = <!Cuts|Nothing!> && minDeltaPhiJet2Met<0.7
    ...
    TCut weightmc = "efflumi * (2.32/3.) * sign(genWeight) * puWeight  * weightBtag(Jet_pt[hJidx[0]], Jet_eta[hJidx[0]] , abs(Jet_hadronFlavour[hJidx[0]])) * weightBtag(Jet_pt[hJidx[1]], Jet_eta[hJidx[1]], abs(Jet_hadronFlavour[hJidx[1]]))"  ;
    ...
    */
    ...
    TString varN[20] =     { "run==1 ? met_shifted_JetResUp_pt: met_pt" , "run==1? met_shifted_JetResDown_pt : met_pt" , "run==1?met_shifted_JetEnUp_pt:met_pt" , "run==1? met_shifted_JetEnDown_pt:met_pt",   "V_pt", "HaddJetsdR08_mass",    "HaddJetsdR08_pt"     ,"Sum$(Jet_pt>30 && Jet_puId>3 &&  abs(Jet_eta)<2.5)" , "min( abs( deltaPhi(met_phi,Jet_phi[hJidx[0]] )), abs(deltaPhi(met_phi,Jet_phi[hJidx[1]])) )", "htJet30" , "max(Jet_pt[hJidx[0]], Jet_pt[hJidx[1]])", "min(Jet_pt[hJidx[0]], Jet_pt[hJidx[1]])", "Jet_btagCSV[hJidx[0]]", "Jet_btagCSV[hJidx[1]]", "met_pt", "nPVs" , "MinIf$( abs( deltaPhi(met_phi,Jet_phi)), Jet_pt>30 && Jet_puId>3 &&  abs(Jet_eta)<2.5)" , "tkMet_pt" , "abs( deltaPhi(met_phi, tkMet_phi))", "abs(deltaPhi(met_phi, H_phi))"};
    TString titleN[20] =   {  ";metJerUp [GeV]" , ";metJerDown [GeV]" , ";metJecUp [GeV]", ";metJecDown [GeV]",  ";Vpt [GeV]" , ";Hmass [GeV]", ";HaddJetsdR08_pt[GeV]",";NaddJets",  ";min#Delta#Phi(MET,hJets)" , ";HT [GeV]", ";H_jetPt1 [GeV]",  ";H_jetPt2",  ";btagCSV1" , ";btagCSV2", ";MET[GEV]", ";nPVs", ";min#Delta#Phi(MET,Jets30)" , ";tkMet [GeV]", ";#Delta#Phi(MET,tkMET)" , ";#Delta#Phi(MET,H)"};
    ...
    double xupN[20] =      { 900, 900, 900, 900, 1000, 500,            1000          , 8     ,3.2 , 1000, 1000, 1000, 1 , 1, 900 , 30 , 3.2, 300, 3.2, 3.2};
    ...
    //    TString var = "evalHMETMassiveMt(HaddJetsdR08_mass, HaddJetsdR08_pt, HaddJetsdR08_eta, H_phi,   met_pt, 0 , met_phi)";
    TString var = "evalHMETMassiveMt(HaddJetsdR08_mass, HaddJetsdR08_pt, HaddJetsdR08_eta, H_phi, 91.2,  met_pt, 0 , met_phi)";


    TString title    = ";MT [GeV]";          // the title of the histogram
    TString plotname = "mt";      // the name of the image file
    int nbinsx       = 7;                      // number of bins
    double xlow      = 350;                    // the low edge of x-axis
    double xup       = 1050;                   // the upper edge of x-axis
    bool doRebin = false;
    bool doOverFlow = true;

    options  = "printStat:plotSig:plotData:!plotLog:!plotNorm:plotBoostedZH";    // use "!plotLog" to plot on log-y scale,
    //  MakePlots(ev, var, (cutQCD + trigMC + cutSignalLoose + "evalHMETMassiveMt(HaddJetsdR08_mass, HaddJetsdR08_pt, HaddJetsdR08_eta, H_phi, 91.2,  met_pt, 0 , met_phi)>0") * weightmc ,  cutdata + cutQCD + cutSignalLoose + "evalHMETMassiveMt(HaddJetsdR08_mass, HaddJetsdR08_pt, HaddJetsdR08_eta, H_phi, 91.2,  met_pt, 0 , met_phi)>0" , title, nbinsx, xlow, xup, plotname + "SignalLoose", plotdir, options,     doRebin, 9);
    MakePlots(ev, var, (cutQCD + trigMC + cutSignal0J + "evalHMETMassiveMt(HaddJetsdR08_mass, HaddJetsdR08_pt, HaddJetsdR08_eta, H_phi, 91.2,  met_pt, 0 , met_phi)>0") * weightmc ,  cutdata + cutQCD + cutSignal0J + "evalHMETMassiveMt(HaddJetsdR08_mass, HaddJetsdR08_pt, HaddJetsdR08_eta, H_phi, 91.2,  met_pt, 0 , met_phi)>0" , title, nbinsx, xlow, xup, plotname + "Signal0J", plotdir, options,     doRebin, 6, doOverFlow);
    ...
    MakePlots(ev, var, (cutQCD + trigMC + cutSignal1J + "evalHMETMassiveMt(HaddJetsdR08_mass, HaddJetsdR08_pt, HaddJetsdR08_eta, H_phi, 91.2,  met_pt, 0 , met_phi)>0") * weightmc ,  cutdata + cutQCD + cutSignal1J + "evalHMETMassiveMt(HaddJetsdR08_mass, HaddJetsdR08_pt, HaddJetsdR08_eta, H_phi, 91.2,  met_pt, 0 , met_phi)>0"  , title, nbinsx, xlow, xup, plotname + "Signal1J", plotdir, options,  doRebin, 6, doOverFlow);
    ...
    MakePlots(ev, var, (cutQCD + trigMC + cutSignalSB + "evalHMETMassiveMt(HaddJetsdR08_mass, HaddJetsdR08_pt, HaddJetsdR08_eta, H_phi, 91.2,  met_pt, 0 , met_phi)>0" ) * weightmc ,  cutdata + cutQCD + cutSignalSB + "evalHMETMassiveMt(HaddJetsdR08_mass, HaddJetsdR08_pt, HaddJetsdR08_eta, H_phi, 91.2,  met_pt, 0 , met_phi)>0"  , title, nbinsx, xlow, xup, plotname + "SignalSB", plotdir, options,  doRebin, 6, doOverFlow);
    ...
    MakePlots(ev, var, (cutQCD + trigMC + cutSignal1b + "evalHMETMassiveMt(HaddJetsdR08_mass, HaddJetsdR08_pt, HaddJetsdR08_eta, H_phi, 91.2,  met_pt, 0 , met_phi)>0" ) * weightmc ,  cutdata + cutQCD + cutSignal1b + "evalHMETMassiveMt(HaddJetsdR08_mass, HaddJetsdR08_pt, HaddJetsdR08_eta, H_phi, 91.2,  met_pt, 0 , met_phi)>0" , title, nbinsx, xlow, xup, plotname + "Signal1b", plotdir, options,  doRebin, 6, doOverFlow);
    ...
    MakePlots(ev, var, (cutQCD + trigMC + cutTT ) * weightmc ,  cutdata + cutQCD + cutTT  , title, nbinsx, xlow, xup, plotname + "TTbar", plotdir, options,  doRebin, 6, doOverFlow);




    dcname    = "zp600_mt_TT.txt";   // the datacard name
    wsname    = plotdir + plotname +"TTbar.root";                // the workspace name
    useshapes = false;
    options1  = "unblind:SplusB";
    MakeDatacard(channel, dcname, wsname, useshapes, options1);
    ...
    dcname    = "zp600_mt_Wlight.txt";   // the datacard name
    wsname    = plotdir + plotname +"Wlight.root";                // the workspace name
    useshapes = false;
    ...
    MakePlots(ev, var, (cutQCD + trigMC + cutWbb ) * weightmc ,   cutdata + cutQCD + cutWbb  , title, nbinsx, xlow, xup, plotname + "Wbb", plotdir, options,  doRebin, 6, doOverFlow);
    ...
    dcname    = "zp600_mt_Wbb.txt";   // the datacard name
    wsname    = plotdir + plotname +"Wbb.root";                // the workspace name
    useshapes = false;
    ...
    MakePlots(ev, var, (cutQCD + trigMC + cutZlight ) * weightmc ,   cutdata + cutQCD + cutZlight , title, nbinsx, xlow, xup, plotname + "Zlight", plotdir, options,  doRebin, 6, doOverFlow);
    ...
    dcname    = "zp600_mt_Zlight.txt";   // the datacard name
    wsname    = plotdir + plotname +"Zlight.root";                // the workspace name
    useshapes = false;
    options1  = "unblind:SplusB";
    MakeDatacard(channel, dcname, wsname, useshapes, options1);
    ...
    //    MakePlots(ev, var, (cutQCD + trigMC + cutZbb ) * weightmc ,   cutdata + cutQCD + cutZbb  , title, nbinsx, xlow, xup, plotname + "Zbb", plotdir, options,  doRebin, 6, doOverFlow);
    ...
    //    TString var = "evalHMETMassiveMt(HaddJetsdR08_mass, HaddJetsdR08_pt, HaddJetsdR08_eta, H_phi, 91.2,  met_shifted_JetEnUp_pt, 0 , met_phi)";
     var = "run==1? evalHMETMassiveMt(HaddJetsdR08_mass, HaddJetsdR08_pt, HaddJetsdR08_eta, H_phi, 91.2,  met_shifted_JetEnUp_pt, 0 , met_shifted_JetEnUp_phi):evalHMETMassiveMt(HaddJetsdR08_mass, HaddJetsdR08_pt, HaddJetsdR08_eta, H_phi, 91.2,  met_pt, 0 , met_phi)";


    title    = ";MT [GeV]";          // the title of the histogram
    plotname = "mtJecUp";      // the name of the image file
    //   nbinsx       = 6;                      // number of bins
    // xlow      = 400;                    // the low edge of x-axis
    //xup       = 600;                   // the upper edge of x-axis
    doRebin = false;

    //doRebin, 6, doOverFlow
    options  = "printStat:plotSig:plotData:!plotLog:!plotNorm:plotBoostedZH";    // use "!plotLog" to plot on log-y scale,
    //  MakePlots(ev, var, (cutQCD + trigMC + cutSignalLoose + "evalHMETMassiveMt(HaddJetsdR08_mass, HaddJetsdR08_pt, HaddJetsdR08_eta, H_phi, 91.2,  met_pt, 0 , met_phi)>0") * weightmc ,  cutdata + cutQCD + cutSignalLoose + "evalHMETMassiveMt(HaddJetsdR08_mass, HaddJetsdR08_pt, HaddJetsdR08_eta, H_phi, 91.2,  met_pt, 0 , met_phi)>0" , title, nbinsx, xlow, xup, plotname + "SignalLoose", plotdir, options,     doRebin, 9);
    MakePlots(ev, var, (cutQCD + trigMC + cutSignal0J + "evalHMETMassiveMt(HaddJetsdR08_mass, HaddJetsdR08_pt, HaddJetsdR08_eta, H_phi, 91.2,  met_pt, 0 , met_phi)>0") * weightmc ,  cutdata + cutQCD + cutSignal0J + "evalHMETMassiveMt(HaddJetsdR08_mass, HaddJetsdR08_pt, HaddJetsdR08_eta, H_phi, 91.2,  met_pt, 0 , met_phi)>0" , title, nbinsx, xlow, xup, plotname + "Signal0J", plotdir, options,     doRebin, 6, doOverFlow );
    

    dcname    = "zp600_mt_0J.txt";   // the datacard name
    wsname    = plotdir + plotname +"Signal0J.root";                // the workspace name
    useshapes = false;
    options1  = "unblind:SplusB";
    MakeDatacard(channel, dcname, wsname, useshapes, options1);
    ...
    //    TString var = "evalHMETMassiveMt(HaddJetsdR08_mass, HaddJetsdR08_pt, HaddJetsdR08_eta, H_phi, 91.2,  met_shifted_JetEnDown_pt, 0 , met_phi)";
     var = "run==1? evalHMETMassiveMt(HaddJetsdR08_mass, HaddJetsdR08_pt, HaddJetsdR08_eta, H_phi, 91.2,  met_shifted_JetEnDown_pt, 0 , met_shifted_JetEnDown_phi):evalHMETMassiveMt(HaddJetsdR08_mass, HaddJetsdR08_pt, HaddJetsdR08_eta, H_phi, 91.2,  met_pt, 0 , met_phi)";


    title    = ";MT [GeV]";          // the title of the histogram
    plotname = "mtJecDown";      // the name of the image file
    //    nbinsx       = 6;                      // number of bins
    // xlow      = 400;                    // the low edge of x-axis
    // xup       = 600;                   // the upper edge of x-axis
    doRebin = false;
    ...
    MakePlots(ev, var, (cutQCD + trigMC + cutWlight ) * weightmc ,  cutdata + cutQCD + cutWlight  , title, nbinsx, xlow, xup, plotname + "Wlight", plotdir, options, doRebin, 6, doOverFlow);
    ...
    //    TString var = "evalHMETMassiveMt(HaddJetsdR08_mass, HaddJetsdR08_pt, HaddJetsdR08_eta, H_phi, 91.2,  met_shifted_JetEnDown_pt, 0 , met_phi)";
     ...
     var = "run==1? evalHMETMassiveMt(HaddJetsdR08_mass, HaddJetsdR08_pt, HaddJetsdR08_eta, H_phi, 91.2,  met_shifted_JetResDown_pt, 0 , met_shifted_JetResDown_phi):evalHMETMassiveMt(HaddJetsdR08_mass, HaddJetsdR08_pt, HaddJetsdR08_eta, H_phi, 91.2,  met_pt, 0 , met_phi)";


    title    = ";MT [GeV]";          // the title of the histogram
    plotname = "mtJerDown";      // the name of the image file
    // nbinsx       = 6;                      // number of bins
    // xlow      = 400;                    // the low edge of x-axis
    // xup       = 600;                   // the upper edge of x-axis
    doRebin = false;
    ...
    //    TString var = "evalHMETMassiveMt(HaddJetsdR08_mass, HaddJetsdR08_pt, HaddJetsdR08_eta, H_phi, 91.2,  met_shifted_JetResUp_pt, 0 , met_phi)";
     var = "run==1? evalHMETMassiveMt(HaddJetsdR08_mass, HaddJetsdR08_pt, HaddJetsdR08_eta, H_phi, 91.2,  met_shifted_JetResUp_pt, 0 , met_shifted_JetResUp_phi):evalHMETMassiveMt(HaddJetsdR08_mass, HaddJetsdR08_pt, HaddJetsdR08_eta, H_phi, 91.2,  met_pt, 0 , met_phi)";



    title    = ";MT [GeV]";          // the title of the histogram
    plotname = "mtJerUp";      // the name of the image file
    // nbinsx       = 6;                      // number of bins
    // xlow      = 400;                    // the low edge of x-axis
    //xup       = 600;                   // the upper edge of x-axis
    doRebin = false;
    ...
    MakePlots(ev, var, (cutQCD + trigMC + cutSignal1J + "evalHMETMassiveMt(HaddJetsdR08_mass, HaddJetsdR08_pt, HaddJetsdR08_eta, H_phi, 91.2,  met_pt, 0 , met_phi)>0") * weightmc ,  cutdata + cutQCD + cutSignal1J + "evalHMETMassiveMt(HaddJetsdR08_mass, HaddJetsdR08_pt, HaddJetsdR08_eta, H_phi, 91.2,  met_pt, 0 , met_phi)>0"  , title, nbinsx, xlow, xup, plotname + "Signal1JLogBlind", plotdir, options,  doRebin, 6, doOverFlow);


    options  = "printStat:plotSig:!plotData:!plotLog:!plotNorm:plotBoostedZH";    // use "!plotLog" to plot on log-y scale,

    MakePlots(ev, var, (cutQCD + trigMC + cutSignal1J + "evalHMETMassiveMt(HaddJetsdR08_mass, HaddJetsdR08_pt, HaddJetsdR08_eta, H_phi, 91.2,  met_pt, 0 , met_phi)>0") * weightmc ,  cutdata + cutQCD + cutSignal1J + "evalHMETMassiveMt(HaddJetsdR08_mass, HaddJetsdR08_pt, HaddJetsdR08_eta, H_phi, 91.2,  met_pt, 0 , met_phi)>0"  , title, nbinsx, xlow, xup, plotname + "Signal1JLinBlind", plotdir, options,  doRebin, 6, doOverFlow);
    ...
    var = "evalHMETMassiveMt(HaddJetsdR08_mass, HaddJetsdR08_pt, HaddJetsdR08_eta,  H_phi, 91.2,  met_pt, 0 , met_phi)";
    title    = ";MT [GeV]";          // the title of the histogram
    plotname = "mt";      // the name of the image file
    options  = "printStat:plotSig:!plotData:!plotLog:!plotNorm:plotBoostedZH";    // use "!plotLog" to plot on log-y scale,
    doRebin = false;
    MakePlots(ev, var, (cutQCD + trigMC + cutSignalLoose + "evalHMETMassiveMt(HaddJetsdR08_mass, HaddJetsdR08_pt, HaddJetsdR08_eta,  H_phi, 91.2,  met_pt, 0 , met_phi)>0" ) * weightmc ,  cutdata + cutQCD + cutSignalLoose + "evalHMETMassiveMt(HaddJetsdR08_mass, HaddJetsdR08_pt, HaddJetsdR08_eta,  H_phi, 91.2,  met_pt, 0 ,  met_phi)>0" , title, nbinsx, xlow, xup, plotname + "SignalLoose_3fb", plotdir, options, doRebin, 20 );





    MakePlots(ev, var, (cutQCD + trigMC + cutSignal0J + "evalHMETMassiveMt(HaddJetsdR08_mass, HaddJetsdR08_pt,  HaddJetsdR08_eta, H_phi, 91.2,  met_pt, 0 ,  met_phi)>0") * weightmc ,  cutdata + cutQCD + cutSignal0J + "evalHMETMassiveMt(HaddJetsdR08_mass, HaddJetsdR08_pt,  HaddJetsdR08_eta,  H_phi, 91.2,  met_pt, 0 , met_phi)>0" , title, nbinsx, xlow, xup, plotname + "Signal0J_3fb", plotdir, options, doRebin, 20);
    ...
    MakePlots(ev, var, (cutQCD + trigMC + cutSignal1J + "evalHMETMassiveMt(HaddJetsdR08_mass,  HaddJetsdR08_pt,  HaddJetsdR08_eta ,   H_phi, 91.2,  met_pt, 0 , met_phi)>0" ) * weightmc ,   cutdata + cutQCD + cutSignal1J + "evalHMETMassiveMt(HaddJetsdR08_mass, HaddJetsdR08_pt, HaddJetsdR08_eta, H_phi, 91.2,  met_pt, 91.2, met_phi)>0" , title, nbinsx, xlow, xup, plotname + "Signal1J_3fb", plotdir, options, doRebin, 20);
    ...
    MakePlots(ev, var, (cutQCD + trigMC + cutSignalSB + "evalHMETMassiveMt(HaddJetsdR08_mass, HaddJetsdR08_pt,  HaddJetsdR08_eta,  H_phi, 91.2,  met_pt, 0 ,  met_phi)>0" ) * weightmc , cutdata + cutQCD + cutSignalSB + "evalHMETMassiveMt(HaddJetsdR08_mass, HaddJetsdR08_pt, HaddJetsdR08_eta,  H_phi, 91.2,  met_pt, 0 ,  met_phi)>0"  , title, nbinsx, xlow, xup, plotname + "SignalSB_3fb", plotdir, options, doRebin, 20);
    ...
    MakePlots(ev, var, (cutQCD + trigMC + cutSignal1b + "evalHMETMassiveMt(HaddJetsdR08_mass, HaddJetsdR08_pt, HaddJetsdR08_eta, H_phi, 91.2,  met_pt, 0 , met_phi)>0" ) * weightmc ,  cutdata + cutQCD + cutSignal1b + "evalHMETMassiveMt(HaddJetsdR08_mass, HaddJetsdR08_pt, HaddJetsdR08_eta, H_phi, 91.2,  met_pt, 0 ,  met_phi)>0"  , title, nbinsx, xlow, xup, plotname + "Signal1b_3fb", plotdir, options, doRebin, 20);
...
*/
    ...
    /*   
    dcname    = Form("zp600_mt_NoReg.txt", channel.Data());   // the datacard name
